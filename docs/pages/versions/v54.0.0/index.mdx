...
export default function App() {
  return (
    <View style={styles.container}>
      <Text style={styles.logo}>VidzWorld</Text>
      ...
      <View style={styles.video}>
        ...
        <Text style={styles.videoText}>الفيديو التجريبي</Text>
      </View>

      <TouchableOpacity style={styles.button}>
        <Text style={styles.buttonText}>▶ تشغيل الفيديو</Text>
      </TouchableOpacity>

      <Text style={styles.description}>
        مرحباً بك في VidzWorld
      </Text>
    </View>
  );
}
